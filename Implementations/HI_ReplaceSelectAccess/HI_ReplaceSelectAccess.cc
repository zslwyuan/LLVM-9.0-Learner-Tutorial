...
bool HI_ReplaceSelectAccess::LSR_Mul(Instruction *I, ScalarEvolution *SE)
{
/*
...
// check whether the instruction is Multiplication suitable for LSR
// If suitable, process it
bool HI_ReplaceSelectAccess::LSR_Add(Instruction *I, ScalarEvolution *SE)
{
/*
1.  get the incremental value by using SCEV
2.  insert a new PHI (carefully select the initial constant)
...
void HI_ReplaceSelectAccess::LSR_Process(Instruction *Mul_I, APInt start_val, APInt step_val)
{
/*
1.  get the incremental value by using SCEV
2.  insert a new PHI (carefully select the initial constant)
...
Instruction* HI_ReplaceSelectAccess::find_Incremental_op(Instruction *Mul_I)
{
...
ConstantInt* HI_ReplaceSelectAccess::find_Constant_op(Instruction *Mul_I)
{
    for (int i = 0; i < Mul_I->getNumOperands(); i++)
    {
...
void HI_ReplaceSelectAccess::TraceMemoryAccessinFunction(Function &F)
{
...
void HI_ReplaceSelectAccess::findMemoryAccessin(Function *F)
{
...
void HI_ReplaceSelectAccess::TraceAccessForTarget(Value *cur_node)
{
...
PHINode* HI_ReplaceSelectAccess::byPassBack_BitcastOp_findPHINode(Value* cur_I_value)
{
