...
public:
    ...
    HI_PragmaTargetExtraction(// const char* config_file_name, 
                                             ...
                                             LoopIRName2Depth(this->_LoopIRName2Depth),
                                             LoopIRName2Array(this->_LoopIRName2Array),
    ...
    {
        loopTarget_log->flush(); delete loopTarget_log;
        arrayTarget_Log->flush(); delete arrayTarget_Log;
    }
