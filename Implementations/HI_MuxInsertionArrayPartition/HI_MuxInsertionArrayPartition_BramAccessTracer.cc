...
HI_MuxInsertionArrayPartition::HI_AccessInfo HI_MuxInsertionArrayPartition::getAccessInfoFor(Value *target, Instruction *access, int initial_offset, std::vector<int> *inc_indices, std::vector<int> *trip_counts, bool unpredictable)
{
...
AliasResult HI_MuxInsertionArrayPartition::HI_AAResult::alias(const MemoryLocation &LocA, const MemoryLocation &LocB)
{
    //   auto PtrA = LocA.Ptr;
    //   auto PtrB = LocB.Ptr;
