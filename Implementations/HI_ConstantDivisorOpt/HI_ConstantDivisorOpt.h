...
public:
    ...
    ~HI_ConstantDivisorOpt()
    {
        ...
        DivisionOptLog->flush(); delete DivisionOptLog;
    ...
    /// by a magic number.  
    Value* generateSignedDivisionByConstant(Value *Dividend,
                                               ConstantInt *Divisor,
                                           IRBuilder<> &Builder);
    ...
    /// TargetLowering::BuildSDIV that replaces division with multiplication
    /// by a magic number.
    Value* generateUnsignedDivisionByConstant(Value *Dividend,
                                                    ConstantInt *Divisor,
                                                    IRBuilder<> &Builder);
