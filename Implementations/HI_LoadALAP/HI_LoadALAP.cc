...
bool HI_LoadALAP::tryReorderIntAdd(Instruction *AddI)
{
    ...
    if (DEBUG)
        *HI_LoadALAPLog << "new add instruction generated: " << *newAddAll_V << " to replace " << *AddI << " and the new block is:\n";
...
bool HI_LoadALAP::tryReorderIntMul(Instruction *MulI)
{
    ...
    if (DEBUG)
        *HI_LoadALAPLog << "new Mul instruction generated: " << *newMulAll_V << " to replace " << *MulI << " and the new block is:\n";
...
bool HI_LoadALAP::tryReorderFloatAdd(Instruction *AddI)
{
    ...
    if (DEBUG)
        *HI_LoadALAPLog << "new add instruction generated: " << *newAddAll << " to replace " << *AddI << " and the new block is:\n";
