...
*/
void HI_SimpleTimingEvaluation::LoopLatencyEvaluation_traversFromHeaderToExitingBlocks(double tmp_critical_path, Loop* L, BasicBlock *curBlock)
{
...
*/
void HI_SimpleTimingEvaluation::MarkBlock_traversFromHeaderToExitingBlocks(double total_latency, Loop* L, BasicBlock *curBlock)
{
    BlockVisited.insert(curBlock);
