...
*/
// HI_ArraySensitiveToLoopLevel::timingBase HI_ArraySensitiveToLoopLevel::analyzeFunction(Function *F) 
// {
...
// void HI_ArraySensitiveToLoopLevel::analyzeFunction_traverseFromEntryToExiting(HI_ArraySensitiveToLoopLevel::timingBase tmp_critical_path, Function *F, BasicBlock* curBlock, HI_ArraySensitiveToLoopLevel::resourceBase &resourceAccumulator)
// {
...
// int HI_ArraySensitiveToLoopLevel::getFunctionStageNum(HI_ArraySensitiveToLoopLevel::timingBase tmp_critical_path, Function *F, BasicBlock* curBlock)
// {
...
HI_ArraySensitiveToLoopLevel::resourceBase HI_ArraySensitiveToLoopLevel::getFunctionResource(Function *F)
{
...
HI_ArraySensitiveToLoopLevel::resourceBase HI_ArraySensitiveToLoopLevel::costRescheduleFPDSPOperators_forFunction(Function* F)
{
