#ifndef _HI_WithDirectiveTimingResourceEvaluation_TEST
#define _HI_WithDirectiveTimingResourceEvaluation_TEST
...
class HI_WithDirectiveTimingResourceEvaluation_TEST {
public:

    // Pass for simple evluation of the latency of the top function, without considering HLS directives
    HI_WithDirectiveTimingResourceEvaluation_TEST(const char* config_file_name) 
    {
        config_file = new std::ifstream(config_file_name);
    } // define a pass, which can be inherited from ModulePass, LoopPass, FunctionPass and etc.

    ~HI_WithDirectiveTimingResourceEvaluation_TEST()
    {
    }
