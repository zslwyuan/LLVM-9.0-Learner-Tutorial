#include "HI_WithDirectiveTimingResourceEvaluation_TEST.h"
...
void HI_WithDirectiveTimingResourceEvaluation_TEST::Parse_Config()
{
    std::string  tmp_s;  
...
void HI_WithDirectiveTimingResourceEvaluation_TEST::Load_Instruction_Info()
{
    int i;
...
HI_WithDirectiveTimingResourceEvaluation_TEST::inst_timing_resource_info HI_WithDirectiveTimingResourceEvaluation_TEST::get_inst_info(std::string opcode, int operand_bitwid , int res_bitwidth, std::string period)
{
...
// int HI_WithDirectiveTimingResourceEvaluation_TEST::get_N_FF(std::string opcode, int operand_bitwid , int res_bitwidth, std::string period)
// {
//     if (checkInfoAvailability( opcode, operand_bitwid , res_bitwidth, period))
...
// int HI_WithDirectiveTimingResourceEvaluation_TEST::get_N_LUT(std::string opcode, int operand_bitwid , int res_bitwidth, std::string period)
// {
//     if (checkInfoAvailability( opcode, operand_bitwid , res_bitwidth, period))
...
// int HI_WithDirectiveTimingResourceEvaluation_TEST::get_N_Lat(std::string opcode, int operand_bitwid , int res_bitwidth, std::string period)
// {
//     if (checkInfoAvailability( opcode, operand_bitwid , res_bitwidth, period))
...
// double HI_WithDirectiveTimingResourceEvaluation_TEST::get_N_Delay(std::string opcode, int operand_bitwid , int res_bitwidth, std::string period)
// {
//     if (checkInfoAvailability( opcode, operand_bitwid , res_bitwidth, period))
...
bool HI_WithDirectiveTimingResourceEvaluation_TEST::checkInfoAvailability(std::string opcode, int operand_bitwid , int res_bitwidth, std::string period)
{
...
HI_WithDirectiveTimingResourceEvaluation_TEST::inst_timing_resource_info HI_WithDirectiveTimingResourceEvaluation_TEST::checkInfo_HigherFreq(std::string opcode, int operand_bitwid , int res_bitwidth, std::string period)
{
    int i;
