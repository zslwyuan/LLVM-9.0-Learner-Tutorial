...
public:
    ...
    HI_LoopUnroll(  std::map<std::string, std::string> &_IRLoop2LoopLabel,
                    std::map<std::string, int> &_LoopLabel2UnrollFactor,
                    int OptLevel = 2, bool OnlyWhenForced = false,
        ...
        : LoopPass(ID), OptLevel(OptLevel), OnlyWhenForced(OnlyWhenForced),
            ...
            ProvidedUpperBound(UpperBound), ProvidedAllowPeeling(AllowPeeling), IRLoop2LoopLabel(_IRLoop2LoopLabel), LoopLabel2UnrollFactor(_LoopLabel2UnrollFactor) {
